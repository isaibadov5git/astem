# AstemLab — Documentation

Numbered, modular. Read in order for full context, or jump straight to the file
that owns the topic. Each fact has exactly one home — cross-link, don't copy.

| # | File | Owns |
|---|---|---|
| 01 | [01-company-overview.md](01-company-overview.md) | Identity, mission, value proposition, COP model, audience |
| 02 | [02-technology.md](02-technology.md) | 4-stage pipeline, AI control layer, scientific base |
| 03 | [03-solutions.md](03-solutions.md) | Sector tracks, commercial models |
| 04 | [04-metrics-and-feasibility.md](04-metrics-and-feasibility.md) | **All public numbers**, 1.8 MW pilot, calculator spec |
